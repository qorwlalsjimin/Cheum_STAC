package com.mirim.cheum_stac.Product.Fragment;
...
import com.mirim.cheum_stac.fill_detail;
...
public class fill_product extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        private Boolean getBGRHeart(String d) {
            return d.equals("heart") ? true : false;
        }
    private int getBGR(Boolean heart) {
